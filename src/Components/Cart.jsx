            ...
            {/* <!-- cart --> */}
          {
           ...
           <div className="row my-3">
            ...
            <div className="col-lg-4">
                            <div className="total-section">
                                ...
                                <div className="cart-buttons">
                                   ...
                                   <Link to="/checkout" className="btn menu-bg  text-light black text-center w-100">Check Out</Link>
                                </div>
                            </div>
                            </div>
            ...
            <div className="my-3 text-center"  >
                ...
                <Link to ="/shop/All/All/All" className='btn btn-primary '>Shoping page</Link>
            </div>
