                        ...
                        <div className="col-lg-5">
                            <div className="contact-form-wrap">
                                ...
                                <div className="contact-form-box">
                                    ...
                                    <p><i className='fa fa-phone'></i> :  <a href="tel:7451826877">7451826877</a> <br /> <i className='fa fa-envelope'></i> : <a href="mailto:vijayrawat1007@gamil.com">vijayrawat1007@gmail.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
